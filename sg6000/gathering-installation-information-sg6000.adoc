...
== 連線SANtricity 至儲存控制器上的《Sytricity System Manager》所需的資訊

您必須將應用裝置中的兩個儲存控制器（E2800控制器或EF570控制器）連接至SANtricity 您將用於「支援非功能性系統管理程式」的管理網路。控制器位於每個應用裝置中、如下所示：

* SG6060：控制器A位於頂端、控制器B位於底部。
...
[[information-needed-to-connect-and-configure-the-1025-gbe-ports-on-the-sg6000-cn-controller]]
...
|===
.相關資訊
link:controllers-in-sg6000-appliances.html["SG6000應用裝置中的控制器"]
