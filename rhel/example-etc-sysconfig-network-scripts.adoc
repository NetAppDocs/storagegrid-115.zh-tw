...
sidebar: sidebar 
keywords:  
summary: 您可以使用範例檔案、將四個Linux實體介面集合成單一LACP連結、然後建立三個VLAN介面將連結子化、做StorageGRID 為「支援網格」、「管理」和「用戶端」網路介面。 
---
...
[role="lead"]
您可以使用範例檔案、將四個Linux實體介面集合成單一LACP連結、然後建立三個VLAN介面將連結子化、做StorageGRID 為「支援網格」、「管理」和「用戶端」網路介面。
